...
Item {
    ...
    Row {
        id:nameRow
        width: monthlyPaidEmployeeDetail.width
        height: UiSchemes.vscale(50)
        anchors.top: monthlyPaidEmployeeDetail.top
        anchors.left: monthlyPaidEmployeeDetail.left
        TextRect {
            id: nameTitle
    ...
    Rectangle {
        id:addSalaryRect
        anchors.fill: monthlyPaidEmployeeDetail
        color: "#FFFFFF"
        visible: false
                ...
                TextInput {
                    ...
                    onFocusChanged: {
                        if(employeeCMPData.focus)
                            updateKeyboardPosition(180, 320, monthlyPaidEmployeeDetail.width - UiSchemes.hscale(50))
                    }
                }
            }
        ...
        PushButton {
            ...
            onButtonClicked: {
                if(employeeObject.addSalary(selectedateData.currentDate,employeeCMPData.text))
                {
